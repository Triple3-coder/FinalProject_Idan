...
<body>
    <div class="container">
        ...
        <div class="reservation-details">
            ...
            <div class="detail-item">
                <span class="detail-label">סכום סופי ששולם:</span>
                <span><?php echo $total_amount; ?></span>
            </div>
        </div>
        
        <p>אישור הזמנה נמצא בהזמנות שלך.</p>
        
        <a href="#" onclick="window.print();" class="print-button">הדפס אישור</a>
        <br>
        <a href="../registration/user/my_orders.php" class="button no-print">לדף ההזמנות שלך</a>
    </div>
